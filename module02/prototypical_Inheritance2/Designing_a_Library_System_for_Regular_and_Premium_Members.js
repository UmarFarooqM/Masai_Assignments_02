...
let book1 = new Book("herois","jaggu",true)
// console.log(book1)
let book2 = new Book("kabir","Manesh",true)
// console.log(book2)
let book3 = new Book("hit","Rajamauli",false)
// console.log(book3)
let book4 = new Book("Jana ","rabindraTagore",true)
// console.log(book4)
let book5 = new Book("siva","God",true)
// console.log(book5)
let book6 = new Book("Virat","Kohli",true)
// console.log(book6)
let Member1 = new Member("viratkohli")
let PremiumMember1 = new PremiumMember("Umar Farooq")
let PremiumMember2 = new PremiumMember("rohitsharma")
